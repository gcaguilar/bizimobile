...
class ChangelogVersioningTest {
  ...
  fun pendingChangelogVersion_requiresCatalogAndNewerLastSeen() {
    val catalog = setOf("0.18.1", "0.19.0", "0.21.0", "0.22.0")
    ...
    assertNull(pendingChangelogVersion("0.20.0", "0.19.0", catalog))
    assertEquals("0.21.0", pendingChangelogVersion("0.21.0", "0.19.0", catalog))
    assertEquals("0.22.0", pendingChangelogVersion("0.22.0", "0.21.0", catalog))
    assertEquals("0.22.0", pendingChangelogVersion("0.22.3", "0.21.0", catalog))
    assertNull(pendingChangelogVersion("0.22.0", "0.22.0", catalog))
  }
}
