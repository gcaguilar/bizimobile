...
class CityChangeUseCaseTest {
  @Test
  fun `change city clears favorites refreshes stations and can confirm onboarding`() =
    runTest {
      val settingsRepository =
        FakeCityChangeSettingsRepository(
  ...
  @Test
  fun `change city can preserve favorites and still confirms city`() =
    runTest {
      val settingsRepository =
        FakeCityChangeSettingsRepository(
