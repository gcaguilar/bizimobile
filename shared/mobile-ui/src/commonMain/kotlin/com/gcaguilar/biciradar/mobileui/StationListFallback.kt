...
/**
 * Fallback UI compartido para cuando no hay un renderer de mapa disponible.
 *
 * Usado por los Adapters de Android (fallback cuando no hay EmbeddedMapProvider)
 * y JVM/desktop (sin mapa embebido).
 */
@Composable
internal fun StationListFallback(
  ...
  colors: BiziColors = LocalBiziColors.current,
) {
  Surface(
