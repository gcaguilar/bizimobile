...
const interests = [
  { value: 'bikes', label: 'Finding bikes' },
  { value: 'docks', label: 'Finding docks' },
  { value: 'alerts', label: 'Getting alerts' },
  { value: 'widgets', label: 'Using widgets and shortcuts' },
];
...
export const en = {
  ...
  home: {
    ...
    hero: {
      ...
      microcopy: 'Request access and we will use your email to manage your Android beta invite.',
    ...
    betaForm: {
      title: 'Android beta access',
      description:
        'We will use your email to manage beta access and prioritize cities with the strongest demand.',
      helper:
        'It also helps us measure system, platform, widget, and usage-interest across the funnel.',
      ...
      successMessage: 'Your request is saved. We will email you when access opens.',
      ...
      fields: {
        ...
        city: { label: 'City', placeholder: 'Choose your main city' },
        bikeSystem: {
          label: 'Bike system',
          placeholder: 'Choose the system you use most',
        },
        frequency: {
          label: 'Usage frequency',
          placeholder: 'How often do you use shared bikes?',
        },
        interest: {
          label: 'Main interest',
          placeholder: 'What matters most to you in BiciRadar?',
        },
        widgets: {
          label: 'Interested in widgets?',
          placeholder: 'Choose an option',
        },
        smartwatch: {
          label: 'Do you use a smartwatch?',
          placeholder: 'Choose an option',
        },
      },
      validation: {
      ...
      items: [
        {
          ...
          answer: 'Complete the form and we will invite you by email as new spots open.',
        },
        {
          question: 'Does BiciRadar replace the official app?',
          answer:
            'No. It is designed as a fast layer for availability checks, favorites, and alerts.',
        },
        {
          question: 'Can I use it if I already have the official app?',
          answer: 'Yes. BiciRadar is focused on reducing friction in daily quick checks.',
        },
        {
          question: 'Will it support more cities?',
          answer:
            'Yes. The architecture is prepared to grow by city and system whenever official data is available.',
        },
        {
          question: 'What happens to my UTMs and my signup?',
          answer:
            'We attach campaign data to each lead so we can measure the funnel without reusing it elsewhere.',
        },
      ],
    },
    footer: {
  ...
  thankYou: {
    ...
    primaryCta: 'View supported cities',
