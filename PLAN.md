...
- Alcance v1: estaciones cercanas, disponibilidad, detalle de estación, favoritos, mapa, rutas delegadas a mapas nativos, shortcuts/App Actions en Android, App Intents/App Shortcuts en iOS/watchOS y Gemini in-app en Android mediante proxy seguro.
...
- Consumir datos públicos de Bizi Zaragoza directamente desde shared con Ktor y normalizarlos a modelos internos de estaciones, disponibilidad, favoritos y consultas cercanas.
...
- Añadir backend mínimo solo para Gemini como relay/proxy seguro.
